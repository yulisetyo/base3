...
INSERT INTO `user_menus` (`id`, `title`, `link_url`, `category`, `have_child`, `parent_id`, `sequence`, `active`, `granted_role`, `icon_fa`, `created_at`, `updated_at`) VALUES
	(7, 'Agenda Rapat', '#', 3, 0, 3, 4, 1, '+00+', 'glyphicon glyphicon-asterisk', '2019-03-29 20:15:57', '0000-00-00 00:00:00');
INSERT INTO `user_menus` (`id`, `title`, `link_url`, `category`, `have_child`, `parent_id`, `sequence`, `active`, `granted_role`, `icon_fa`, `created_at`, `updated_at`) VALUES
	(8, 'Referensi', '#', 1, 1, 0, 99, 1, '+00+', 'glyphicon glyphicon-book', '2019-03-29 20:15:27', '0000-00-00 00:00:00');
INSERT INTO `user_menus` (`id`, `title`, `link_url`, `category`, `have_child`, `parent_id`, `sequence`, `active`, `granted_role`, `icon_fa`, `created_at`, `updated_at`) VALUES
