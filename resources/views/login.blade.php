...
<head>
  ...
  <link rel="stylesheet" href="{{ asset($baseurl.'/adminlte/bootstrap/css/bootstrap.min.css') }}">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/4.5.0/css/font-awesome.min.css">
  <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/ionicons/2.0.1/css/ionicons.min.css">
  <link rel="stylesheet" href="{{ asset($baseurl.'/adminlte/dist/css/AdminLTE.min.css') }}">
  <link rel="stylesheet" href="{{ asset($baseurl.'/adminlte/plugins/iCheck/square/blue.css') }}">
  <link rel="stylesheet" href="{{ asset($baseurl.'/adminlte/plugins/alertifyjs/css/alertify.css') }}">
  <link rel="stylesheet" href="{{ asset($baseurl.'/adminlte/plugins/alertifyjs/css/themes/default.css') }}">
  <script src="{{ asset($baseurl.'/adminlte/plugins/jQuery/jquery-2.2.3.min.js') }}" type="text/javascript"></script>
</head>
...
<script src="{{ asset($baseurl.'/adminlte/plugins/alertifyjs/alertify.min.js') }}"></script>
<script src="{{ asset($baseurl.'/adminlte/bootstrap/js/bootstrap.min.js') }}"></script>
<script src="{{ asset($baseurl.'/adminlte/plugins/iCheck/icheck.min.js') }}"></script>
<script>
