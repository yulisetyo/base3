...
<head>
	...
	<link rel="stylesheet" href="{{ asset('/public/adminlte/plugins/datatables/dataTables.bootstrap.css ') }}">
	<link rel="stylesheet" href="{{ asset('/public/adminlte/plugins/alertifyjs/css/alertify.css ') }}">
	<link rel="stylesheet" href="{{ asset('/public/adminlte/plugins/alertifyjs/css/themes/default.css ') }}">
	<link rel="stylesheet" href="{{ asset('/public/adminlte/plugins/chosen/chosen.css ') }}">
	<link rel="stylesheet" href="{{ asset('/public/adminlte/plugins/pekeupload/css/custom.css ') }}">	
	<link rel="stylesheet" href="{{ asset('/public/adminlte/plugins/pekeupload/css/themes/bootstrap/css/bootstrap.css ') }}">
	<link rel="stylesheet" href="{{ asset('/public/adminlte/plugins/pekeupload/css/themes/bootstrap/css/bootstrap-theme.css ') }}">
	<link rel="stylesheet" href="{{ asset('/public/adminlte/plugins/jquery-file-upload/css/jquery.fileupload.css ') }}">
	<script src="{{ asset('/public/adminlte/plugins/jQuery/jquery-2.2.3.min.js ') }}" type="text/javascript"></script>
	<script src="{{ asset('/public/adminlte/plugins/jQueryUI/jquery-ui.min.js ') }}" type="text/javascript"></script>
	<script>
...
<!--<body class="hold-transition skin-blue sidebar-collapse sidebar-mini">-->
	<div class="wrapper">
					...
					<ul class="nav navbar-nav">
						<li class="dropdown user user-menu">
							<a href="#" class="dropdown-toggle" data-toggle="dropdown">
								...
								<img src="{{ url('/public/adminlte/dist/img/avatar2.png') }}" class="user-image" alt="User Image">
								<?php } else {?>
								<img src="{{ url('/public/adminlte/dist/img/avatar5.png') }}" class="user-image" alt="User Image">
								<?php } ?>
							...
							<ul class="dropdown-menu">
								<li class="user-header">
									<?php if(Session::get('jnskel') == 'P') {?>
									<img src="{{ url('/public/adminlte/dist/img/avatar2.png') }}" class="img-circle" alt="User Image">
									<?php } else {?>
			...
			<section class="sidebar">
				<div class="user-panel">
					...
					<div class="pull-left info">
						...
						<a href="#"><i class="fa f
						a-circle text-success"></i> Online</a>
					</div>
				</div>
		...
		<footer class="main-footer">
			...
			<strong>Copyright &copy; 2019 <a target="_blank" href="http://www.djpbn.kemenkeu.go.id/portal/id">Direktorat Jenderal Perbendaharaan - Kementerian Keuangan</a>.</strong> All rights reserved.
		</footer>
	</div>
	...
	<script src="{{ asset('/public/adminlte/plugins/alertifyjs/alertify.min.js ') }}"></script>
	<script src="{{ asset('/public/adminlte/plugins/chosen/chosen.jquery.min.js ') }}"></script>
